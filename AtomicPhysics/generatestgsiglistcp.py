...
fivedfivenl = list(range(79,116))
dirfivedfivenl = [79,80] + list(range(83,116))
fivedfoursixsnl = list(range(5,42))
dirfivedfoursixsnl = [5,6] + list(range(9,42))
fivedthreesixstwonl = list(range(42,79))
dirfivedthreesixstwonl = [42,43] + list(range(46,79))
alldirect = dirfivedfivenl + dirfivedfoursixsnl + dirfivedthreesixstwonl

conflist = (fivedfivenl, dirfivedfivenl, fivedfoursixsnl, dirfivedfoursixsnl,fivedthreesixstwonl,dirfivedthreesixstwonl,alldireect)

terms = TERMS('TERMSreordered')
for i in conflist:
    terms.makestgsiglist(i, 1, [369,15960], 'stgsiglist'+str(conflist.index(i)), elastic=False)
